    ...
    public static void main(String[] args) {
      ...
      // superclass ref = subclass object();
        ...
        // ob.display();
         ...
         // Finding Salary of Manager with Commision added
         ob = new Manager(100,"Preet Ganguly",85000,20,15,"Development",12000);
         double sal = ob.calcAnnSal();
         System.out.println("Salary of Manager with Commision added: " + sal);
