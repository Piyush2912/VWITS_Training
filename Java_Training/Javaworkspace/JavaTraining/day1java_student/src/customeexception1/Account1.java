...
public class Account1 {
	...
	public Account1(String accountHolderName, int acctNo, double balance) {
		super();
	...
	public double withdraw(double amt) throws InsufficientBalanceException, ZeroBalanceException,NegativeBalanceException
	{
		if(amt <= this.balance )
		{
			this.balance = this.balance - amt;
			...
			throw new NegativeBalanceException(this.balance,amt,this.acctNo);
		}
		else
		{
